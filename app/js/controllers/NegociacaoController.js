System.register(["../views/NegociacoesView", "../views/MensagensView", "../models/Negociacoes", "../models/Negociacao"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var NegociacoesView_1, MensagensView_1, Negociacoes_1, Negociacao_1, NegociacaoController;
    return {
        setters: [
            function (NegociacoesView_1_1) {
                NegociacoesView_1 = NegociacoesView_1_1;
            },
            function (MensagensView_1_1) {
                MensagensView_1 = MensagensView_1_1;
            },
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                constructor() {
                    ...
                    this._mensagensView = new MensagensView_1.MensagensView('#mensagemView');
